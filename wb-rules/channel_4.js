...
defineRule("ch4_from_angle_to_voltage", {
whenChanged: "Channel_4/SetAngle",
then: function(newValue, devName, cellName) {
  dev["wb-mao4_26/Channel 4 Dimming Level"] = sk * newValue;
}
});

// from voltage to angle
defineRule("ch4_from_voltage_to_angle", {
whenChanged: "wb-mai6_89/IN 2 P Voltage",
then: function(newValue, devName, cellName) {
  angle_val = Math.round(gk * newValue)+1;
  if (angle_val > 90){
    dev["Channel_4/FeedbackAngle"] = 90;
  }
  else if (angle_val <= 1){
    dev["Channel_4/FeedbackAngle"] = 0;
  }
  else{
    dev["Channel_4/FeedbackAngle"] = angle_val;
  }
}
});
...
whenChanged: "Channel_4/LastSetAngle",
then: function(newValue, devName, cellName) {
...
whenChanged: "Channel_4/SetLastAngle",
then: function(newValue, devName, cellName) {
  dev["Channel_4/SetAngle"] = last_set_angle;
}
});
