...
defineRule("ch1_from_angle_to_voltage", {
whenChanged: "Channel_1/SetAngle",
then: function(newValue, devName, cellName) {
  dev["wb-mao4_26/Channel 1 Dimming Level"] = sk * newValue;
}
});

// from voltage to angle
defineRule("ch1_from_voltage_to_angle", {
whenChanged: "wb-mai6_89/IN 1 N Voltage",
then: function(newValue, devName, cellName) {
  angle_val = Math.round(gk * newValue)+1;
  if (angle_val > 90){
    dev["Channel_1/FeedbackAngle"] = 90;
  }
  else if (angle_val <= 1){
    dev["Channel_1/FeedbackAngle"] = 0;
  }
  else{
    dev["Channel_1/FeedbackAngle"] = angle_val;
  }
}
});
...
whenChanged: "Channel_1/LastSetAngle",
then: function(newValue, devName, cellName) {
...
whenChanged: "Channel_1/SetLastAngle",
then: function(newValue, devName, cellName) {
  dev["Channel_1/SetAngle"] = last_set_angle;
}
});
